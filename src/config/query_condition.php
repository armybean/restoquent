...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This setting tells Restoquent how to give directives to the remote API which govern how conditions on a
    | collection fetch should be conveyed.
    |
    | Supported Options:
    |
    | get_array_params - This option will send the collection query conditions as an array of GET parameters nested
    |                    under the search.container_parameter parameter defined in the config. The resulting GET
    ...
    */
    ...
    'get_array_params' => [
        ...
        // Name of the parameter key used to specify a search rule operator, i.e.: = >= <= != LIKE
        'operator'            => 'operator',
