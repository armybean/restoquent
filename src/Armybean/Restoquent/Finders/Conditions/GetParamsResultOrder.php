 ...
 * Date: 15.11.2016
 * Time: 15:24
 * Filename: GetParamsResultOrder.php
 *
 * $Rev$
 * $Date$
 */
...
/**
 * Class to manage how sorting requirements for results returned by a request, where the directives are passed as HTTP
 * GET parameters with particular parameter names (defined in the config). The resulting GET params might be something
 * like:
 *
 * <code>
...
class GetParamsResultOrder implements QueryResultOrderInterface {
    ...
    /**
     * Var to hold the order by field that the results should be sorted on
     *
     * @var string
     */
    ...
    /**
     * Var to hold the order direction for results to be returned
     *
     * @var string
     */
     ...
     *
     * @return QueryResultOrderInterface
     */
    ...
    /**
     * Function to add all the directives that have been given to the class to a given request object
     *
    ...
    /**
     * Function to convert the directives represented in this class to an array, this is useful for testing
     *
     * @return array
     */
    ...
    /**
     * Function to convert the directives represented in this class to a querystring, this is useful for testing
     *
     * @return string
     */
